...
;Includes
INCLUDE Main\Consts.asm
INCLUDE Main\Graphics.asm
INCLUDE Main\Keyboard.asm
INCLUDE Main\Port.asm
...
InitGame PROC
    ...
    DisplayStr WaitingGameLevelMsg
...
DrawScore PROC
    ...
    DisplayStr GameLevelLabel
    DisplayChar GameLevel
    ;==================================
